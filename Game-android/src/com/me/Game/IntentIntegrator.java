...
public class IntentIntegrator {
  ...
  public static final String DEFAULT_MESSAGE =
      "El escaneo de boletos requiere instalar la aplicacion Barcode Scanner. ¿Quieres instalarla?";
...
/*public final class IntentIntegrator 
{
	...
	public static final String DEFAULT_MESSAGE = "Esta aplicación requiere un escaner de codigo de barras, desea instalarlo ahora?";
	...
	public static AlertDialog initiateScan(Activity activity, CharSequence stringTitle, CharSequence stringMessage, CharSequence stringButtonYes, CharSequence stringButtonNo, CharSequence stringDesiredBarcodeFormats) 
	{
		...
		catch (ActivityNotFoundException e) { return showDownloadDialog(activity, stringTitle, stringMessage, stringButtonYes, stringButtonNo); }
	}
	...
	public static IntentResult parseActivityResult(int requestCode, int resultCode, Intent intent) 
	{
		if (requestCode == REQUEST_CODE) 
		{
			...
			else { return new IntentResult(null, null);}
		}
		return null;
	}
	...
	public static void shareText(Activity activity, CharSequence text, CharSequence stringTitle, CharSequence stringMessage, CharSequence stringButtonYes, CharSequence stringButtonNo) 
	{
		...
		catch (ActivityNotFoundException e) { showDownloadDialog(activity, stringTitle, stringMessage, stringButtonYes, stringButtonNo);}
	}
}*/